module DO {
    ...
    export function getConfig(): any {
        return {
            ...
            html_pages: [
                ...
                {
                    id: "error",
                    html: "../common/assets/ui_4/html/error.html",
                    module: "DO.HTMLPageClasses.Error",
                    variants_css: {
                        default: "../common/assets/ui_4/html/error-default.css",
                        mobile: {
                            landscape: null,
                            portrait: null
                        }
                ...
                {
                    id: "dialog",
                    html: "../common/assets/ui_4/html/dialog.html",
                    module: "DO.HTMLPageClasses.Dialog",
                    variants_css: {
                        default: "../common/assets/ui_4/html/dialog-default.css",
                        mobile: {
                            landscape: null,
                            portrait: null
                        }
                ...
                {
                    id: "main",
                    html: "../common/assets/ui_4/html/main.html",
                    module: "DO.HTMLPageClasses.Main",
                    variants_css: {
                        default: "../common/assets/ui_4/html/main-default.css",
                        mobile: {
                            landscape: "../common/assets/ui_4/html/main-mobile-landscape.css",
                            portrait: "../common/assets/ui_4/html/main-mobile-portrait.css"
                        }
                    }
                },
                {
                ...
                },
                {
                    id: "panel",
                    html: {
                        desktop: "../common/assets/ui_4/html/panel-desktop.html",
                        mobile: "../common/assets/ui_4/html/panel-mobile.html"
                    },
                    module: "DO.Slots.ControlPanel.ControlPanel",
                    variants_css: {
                        default: "../common/assets/ui_4/html/panel-default.css",
                        desktop: "../common/assets/ui_4/html/panel-desktop.css",
                        mobile: {
                            landscape: "../common/assets/ui_4/html/panel-mobile-landscape.css",
                            portrait: "../common/assets/ui_4/html/panel-mobile-portrait.css"
                        }
                    }
                },
                {
                    id: "game_over",
                    html: "../common/assets/ui_4/html/game-over.html",
                    module: "DO.HTMLPageClasses.GameOver",
                    variants_css: {
                        default: "../common/assets/ui_4/html/game-over.css",
                        mobile: {
                            landscape: null,
                            portrait: null
                        }
    ...
    export function getDefaultSettings(): any {
        return {
            ...
            "baseGameBlurBGImgURL": "./assets/renderer/base/blur.jpg",
            "portraitBaseBgImgURL": "url('./assets/renderer/base/mobile/static/basegame_mobile_portrait.jpg')",
            "freeSpinBlurBGImgURL": "./assets/renderer/free_spins/blur_fs.jpg",
            "portraitFreeSpinBgImgURL": "url('./assets/renderer/free_spins/mobile/static/freegame_mobile_portrait.jpg')",
            "portraitBaseBg": "url('./assets/renderer/base/mobile/basegame_mobile_portrait.jpg')",
            "autoplayStartButton_enable": "url('../common/assets/ui_4/html/images/settings/buttonPanel/mobile/continue.png')",
            "autoplayStartButton_disable": "url('../common/assets/ui_4/html/images/settings/buttonPanel/mobile/continue_btn_disable.png')",
            "auto_Start_Button_Enable_Color": "#075890 ",
            "auto_Start_Button_Shadow": "0 -1px 16px 0 #075890, 0 6px 20px 0 #075890",
            "totalPaytablePages": 6
        };
    }
