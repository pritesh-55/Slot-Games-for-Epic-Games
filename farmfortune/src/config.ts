module DO {
        ...
        return {
            ...
            scenes: {
                ...
                FREE_SPINS_INTRO: {
                    ...
                    module: "DO.RendererScenes.Game.GameFreeSpinsIntroScene",
                    asset_manifest: "./assets/renderer/base/manifest.json"
                },
                FREE_SPINS: {
                ...
                TRANSITION:{
                    ...
                    module: "DO.RendererScenes.Game.GameFeatureTransitionScene",
                    asset_manifest: "./assets/renderer/base/manifest.json"
                },
                BIG_WIN: {
    ...
    export function getDefaultSettings(): any {
        return {
	        ...
	        "auto_Start_Button_Enable_Color": "#92892d ",
            "auto_Start_Button_Shadow": "0 -1px 16px 0 #fff716, 0 6px 20px 0 #fff716",
