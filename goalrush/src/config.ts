module DO {
    ...
    export function getConfig(): any {
        return {
            ...
            html_pages: [
                ...
                {
                    id: "error",
                    html: "../common/assets/ui_2/html/error.html",
                    module: "DO.HTMLPageClasses.Error",
                    variants_css: {
                        default: "../common/assets/ui_2/html/error-default.css",
                        mobile: {
                            landscape: null,
                            portrait: null
                        }
                ...
                {
                    id: "dialog",
                    html: "../common/assets/ui_2/html/dialog.html",
                    module: "DO.HTMLPageClasses.Dialog",
                    variants_css: {
                        default: "../common/assets/ui_2/html/dialog-default.css",
                        mobile: {
                            landscape: null,
                            portrait: null
                        }
                ...
                },
                {
                    id: "panel",
                    html: {
                        desktop: "../common/assets/ui_2/html/panel-desktop.html",
                        mobile: "../common/assets/ui_2/html/panel-mobile.html"
                    },
                    module: "DO.Slots.ControlPanel.ControlPanel",
                    variants_css: {
                        default: "../common/assets/ui_2/html/panel-default.css",
                        desktop: "../common/assets/ui_2/html/panel-desktop.css",
                        mobile: {
                            landscape: "../common/assets/ui_2/html/panel-mobile-landscape.css",
                            portrait: "../common/assets/ui_2/html/panel-mobile-portrait.css"
                        }
                    }
                },
                {
    ...
    export function getDefaultSettings(): any {
        return {
            ...
            "autoplayStartButton_enable": "url('../common/assets/ui_2/html/images/settings/buttonPanel/mobile/continue.png')",
            "autoplayStartButton_disable": "url('../common/assets/ui_2/html/images/settings/buttonPanel/mobile/continue_btn_disable.png')",
	        "auto_Start_Button_Enable_Color": "#8C6E00 ",
            "auto_Start_Button_Shadow": "0 -1px 16px 0 #8C6E00, 0 6px 20px 0 #8C6E00",
            "totalPaytablePages": 7
        };
    }
